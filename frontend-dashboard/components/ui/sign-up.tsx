          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignUp}>
              ...
              <div className="animate-element animate-delay-400">
                ...
                <GlassInputWrapper>
                  <input name="username" type="text" placeholder="Choose a username" className="w-full bg-transparent text-sm p-4 rounded-2xl focus:outline-none" required />
                </GlassInputWrapper>
              </div>
              ...
              <div className="animate-element animate-delay-800 flex items-start gap-3 text-sm">
                <input type="checkbox" name="agreeToTerms" className="custom-checkbox mt-1" required />
              ...
              <button type="submit" className="animate-element animate-delay-900 w-full rounded-2xl bg-primary py-4 font-medium text-primary-foreground hover:bg-primary/90 transition-colors">
                Create Account
              </button>
            </form>
            ...
            <button onClick={onGoogleSignUp} className="animate-element animate-delay-1100 w-full flex items-center justify-center gap-3 border border-border rounded-2xl py-4 hover:bg-secondary transition-colors">
